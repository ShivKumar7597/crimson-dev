            ...
            <div class="mt-2 py-6 bg-white overflow-hidden shadow-xl p-4">
                ...
                <div class="mt-5">
                    <loading-button
                        :loading="sending"
                        class="btn-indigo"
                        @click.native="syncOpportunities"
        ...
        <template v-if="currentSetup === 3">
            ...
            <div class="mt-2 overflow-x-auto">
                ...
                <table class="w-full bg-white whitespace-no-wrap">
                    ...
                    <table-row
                        v-for="(item, $index) in opportunities.data"
                        :key="$index"
                        :product="item"
...
import TableRow from "./../Shared/OpportunityTableRow";
...
export default {
    ...
    methods: {
        syncOpportunities: function() {
            this.$inertia.visit(this.route("opportunities.sync"), {
                method: "get",
